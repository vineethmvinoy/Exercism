...
You can submit your solution using the `exercism submit src/main/java/ErrorHandling.java src/main/java/CustomCheckedException.java src/main/java/CustomUncheckedException.java` command.
